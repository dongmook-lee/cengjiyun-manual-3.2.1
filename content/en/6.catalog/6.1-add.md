...
### a\) 서비스에서 카탈로그로 저장하는 서비스 맵을 선택![]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/6.1_1.png)

### b\) 화면 우측 상단 카탈로그로 저장' 버튼을 클릭![]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/6.1_2.png)
