...
**참조:** [서비스 계정으로 Cloud Platform 인증](https://cloud.google.com/kubernetes-engine/docs/tutorials/authenticating-to-cloud-platform)
    ...
    * Private key 만들기
    ...
    ![gke-create-service-account-1]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-service-account-1.png)
    ![gke-create-service-account-2]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-service-account-2.png)
    ![gke-create-service-account-3]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-service-account-3.png)
...
* 프로젝트 만들기를 선택합니다.[자세히 알아보기](https://cloud.google.com/resource-manager/docs/creating-managing-projects)
    ...
    * **Location:**  
    ...
    ![gke-create-project-1]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-project-1-1.png)
...
### 1.1 Google Kubernetes Engine API가 사용 설정되었는지 확인합니다.
    ...
    **GOOGLE KUBERNETES ENGINEAPI 사용 설정됨** 을 확인 합니다.
    ...
    ![gke-create-api-lib-1]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-api-lib-1.png)
...
* VPC 네트워크 만들기 선택
    ...
    * **만들기**를 선택합니다.
    ...
    ![gke-create-vpc-1]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-vpc-1.png)
    ![gke-create-vpc-1]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-vpc-2.png)
    ![gke-create-vpc-3]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-vpc-3.png)
...
* **Kubernetes 클러스터 만들기**
    ...
    * **만들기**를 선택합니다.
    ...
    ![gke-create-cluster-1]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-cluster-1.png)
    ![gke-create-cluster-2]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-cluster-2.png)
    ![gke-create-cluster-3]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-cluster-3.png)
    ![gke-create-cluster-4]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-cluster-4.png)
...
* **Cloud Shell에서 실행:**  
    ...
    * Kubernetes 클러스터 목록에서 생성된 클러스터 **연결**을 선택합니다.
    ...
    ![gke-create-cluster-connect-1]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-cluster-connect-1.png)
...
* **kubectl 을 사용하려면:**
    ...
    * 아래 명령어로 확인할 수 있습니다.
        ...
        kubectl get svc
        ```
        ![gke-create-cluster-connect-2]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-cluster-connect-2.png)
...
VM에서 실행되는 애플리케이션은 서비스 계정을 사용하여 Google Cloud API를 호출합니다. 사용할 서비스 계정과 허용할 API 액세스 수준을 선택하세요. [자세히 알아보기](https://cloud.google.com/compute/docs/access/create-enable-service-accounts-for-instances?hl)
    ...
    ![gke-create-instance-1]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-instance-1.png)
...
* **디스크(Disks) 설정**
    ...
    * Add new disk를 선택 합니다.
        ...
        * 노드에 필요한 디스크 사양을 설정 합니다.
        ...
        ![gke-create-instance-disk-1]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-instance-disk-1.png)
    ...
    * **Network interfaces(네트워크 인터페이스)**
        ...
        **인스턴스를 삭제하고 다시 만들 때 IP를 유지하려면 고정 내부 IP 주소를 선택하거나 만드세요.**  
        [자세히 알아보기](https://cloud.google.com/compute/docs/subnetworks)
            ...
            ![gke-create-instance-network-2]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-instance-network-2.png)
...
![gke-create-instance-view-network]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-instance-view-network.png)
...
* **SSH 방화벽 규칙을 추가 한다.**
    ...
    **Specified target tags**를 선택.  
    ...
    ![gke-create-firewall-rules-ssh]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-firewall-rules-ssh.png)
...
* **NFS 방화벽 규칙을 추가 한다.**
    ...
    **Specified target tags**를 선택.  
    ...
    ![gke-create-firewall-rules-nfs]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-firewall-rules-nfs.png)
...
![gke-create-connect-node-ssh-1]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-connect-node-ssh-1.png)
...
* 또는 RSA key pair 수동 생성 / 등록 방법.
    ...
    * 아래 명령으로 RSA key pair를 생성한다.
    ...
    ![gke-create-connect-node-ssh-2]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-connect-node-ssh-2.png)
    ...
    * 생성된 RSA Key 내용을 복사 해서 Compute Engine > Metadata > SSH Keys 에 등록 한다.
        ...
        ![gke-create-connect-node-ssh-3]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-connect-node-ssh-3.png)
        ![gke-create-connect-node-ssh-4]({{< param imageRootDir >}}/assets/KR/{{< param version >}}/GKE/gke-create-connect-node-ssh-4.png)
