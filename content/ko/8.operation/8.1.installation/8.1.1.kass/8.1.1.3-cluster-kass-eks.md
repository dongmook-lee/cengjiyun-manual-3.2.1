...
---
#### [8.1.1.5 EKS 클러스터 만들기 Quick Start](../8.1.1.5-cluster-kass-eks-quick-start)
#### [8.1.1.5 EKS 클러스터 만들기 NAT Gateway 사용](../8.1.1.6-cluster-kass-eks-nat-gateway)
...
### Amazon EKS 필수 조건
  ...
  * AWS 관리자 권한이 없다면 필요한 역할 / 정책 / 권한 을 요청 해야 한다.  
    참조 : [EKS 관리 권한 / 정책](../8.1.1.4-cluster-kass-eks-policy)
